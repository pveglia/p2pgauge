...
N=0
 ...
 rho0=(0.288471 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x0_0=rho0*cos(theta)
 y0_0=rho0*sin(theta)

 rho1=(0.215715 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x0_1=rho1*cos(theta)
 y0_1=rho1*sin(theta)
...
N=1
 ...
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(0.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x1_0=rho0*cos(theta)
 y1_0=rho0*sin(theta)

 rho1=(0.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x1_1=rho1*cos(theta)
 y1_1=rho1*sin(theta)
...
N=4
 ...
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(0.835527 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x4_0=rho0*cos(theta)
 y4_0=rho0*sin(theta)

 rho1=(0.192083 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x4_1=rho1*cos(theta)
 y4_1=rho1*sin(theta)
...
set key left top Lef rev; plot [t=0:0] (1/0),(1/0) t 'KULB_bytes_sent_lastdt' w l lt 1 lc 1 lw 4 ,(1/0),(1/0) t  'KULB_bytes_rec_lastdt' w l lt 1 lc 2 lw 4
unset multiplot
