...
N=0
 ...
 set label 'CAP[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(1.007953 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x0_0=rho0*cos(theta)
 y0_0=rho0*sin(theta)

 rho1=(1.112006 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x0_1=rho1*cos(theta)
 y0_1=rho1*sin(theta)
...
N=1
 ...
 y=10*sin(theta)
 set arrow from 0,0 to x,y lw 1 nohead front
 set label 'sCC[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(1.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x1_0=rho0*cos(theta)
 y1_0=rho0*sin(theta)

 rho1=(1.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x1_1=rho1*cos(theta)
 y1_1=rho1*sin(theta)
...
N=2
 ...
 y=10*sin(theta)
 set arrow from 0,0 to x,y lw 1 nohead front
 set label 'RTT[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(0.001187 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x2_0=rho0*cos(theta)
 y2_0=rho0*sin(theta)

 rho1=(0.011684 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x2_1=rho1*cos(theta)
 y2_1=rho1*sin(theta)
...
N=3
 ...
 y=10*sin(theta)
 set arrow from 0,0 to x,y lw 1 nohead front
 set label 'HOP[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(0.622970 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x3_0=rho0*cos(theta)
 y3_0=rho0*sin(theta)

 rho1=(0.528601 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x3_1=rho1*cos(theta)
 y3_1=rho1*sin(theta)
...
N=4
 ...
 y=10*sin(theta)
 set arrow from 0,0 to x,y lw 1 nohead front
 set label 'sAS[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(1.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x4_0=rho0*cos(theta)
 y4_0=rho0*sin(theta)
...
N=5
 ...
 y=10*sin(theta)
 set arrow from 0,0 to x,y lw 1 nohead front
 set label 'NET[-1,1]' at 12*cos(theta+delta),12*sin(theta+delta)
 set label '2' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(1.000000 + 0.0)/(2 + 0.0)*10.0; # rho=val/max*10
 x5_0=rho0*cos(theta)
 y5_0=rho0*sin(theta)
...
set key left top Lef rev; plot [t=0:0] (1/0),(1/0) t 'CORR_bytes_sent_lastdt' w l lt 1 lc 1 lw 4 ,(1/0),(1/0) t  'CORR_bytes_rec_lastdt' w l lt 1 lc 2 lw 4
unset multiplot
