...
N=0
 ...
 rho0=(0.138264 + 0.0)/(1 + 0.0)*10.0; # rho=val/max*10
 x0_0=rho0*cos(theta)
 y0_0=rho0*sin(theta)

 rho1=(0.192431 + 0.0)/(1 + 0.0)*10.0; # rho=val/max*10
 x0_1=rho1*cos(theta)
 y0_1=rho1*sin(theta)
...
N=2
 ...
 set label '1' at 11*cos(theta+delta), 11*sin(theta+delta)
 rho0=(0.700879 + 0.0)/(1 + 0.0)*10.0; # rho=val/max*10
 x2_0=rho0*cos(theta)
 y2_0=rho0*sin(theta)

 rho1=(0.653338 + 0.0)/(1 + 0.0)*10.0; # rho=val/max*10
 x2_1=rho1*cos(theta)
 y2_1=rho1*sin(theta)
...
set key left top Lef rev; plot [t=0:0] (1/0),(1/0) t 'POT_bytes_sent_lastdt' w l lt 1 lc 1 lw 4 ,(1/0),(1/0) t  'POT_bytes_rec_lastdt' w l lt 1 lc 2 lw 4
unset multiplot
