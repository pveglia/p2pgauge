...
N=1
 ...
 rho1=(0.2 + 0.0)/(1 + 0.0)*10.0; # rho=val/max*10
 x1_1=rho1*cos(theta)
 y1_1=rho1*sin(theta)
...
set key left top Lef rev; plot [t=0:0] (1/0),(1/0) t 'POT_RX_PEER_LAST' w l lt 1 lc 1 lw 4 ,(1/0),(1/0) t  'POT_RX_BYTES_LAST' w l lt 1 lc 2 lw 4
unset multiplot
